    ...
    Statement = [
      {
        ...
        Principal = {
          AWS = [
            ...
            "arn:aws:iam::309217545237:role/updated-crawler-function-role-dev",
            "arn:aws:iam::309217545237:role/updated-crawler-function-role-sb",
            "arn:aws:iam::309217545237:role/updated-crawler-function-role-game",
            "arn:aws:iam::309217545237:role/updated-crawler-function-role-prod",
          ]
        }
        Action = [
            "s3:GetObject",
